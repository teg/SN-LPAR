...
Then $\R(U')<\R(T')$, and $U^n=T^n\in\SN$ since $\FV(u)=\FV(u')$.
	...
	\item
If the reduction step $T\rewrite^1U$ takes place inside the context $\overline{w\D}$, then $\R(U^n)<\R(T^n)$---note that $\R(U')<\R(T')$ by construction.
%
...
%
The innermost element of the context $\overline{w\D}$ is either a closure $\g*$ or an application $(\cdot)v$.
%
