...
%
%The following lemmata are immediate from these definitions.
...
It will be proved that if $T = (u)\overline{w\D} \in\SN$ where $\term\g\in\SN$ for each closure $\g$ of $\overline{\D}$, then $T' = (u)\overline{w\D^*}\in\SN$.
%
