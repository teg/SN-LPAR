...
\smallskip
\\
2.5)  $T = (u\distr xy{\tup^t\share*{\vv^{\vv*z\kern2pt}}y}\G'[0])\overline{w\G}$ and
\\
...
\]
%
Because $t^i$ is already unfolded, we have  $\sn(\lambda y.t)^i = \sn(\lambda y.t\share*{\vv*z}y)^i$.
