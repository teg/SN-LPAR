...
\begin{proof}
We only present the case for rule~\ref{eqn:distributor elimination}, the remaining cases being immediate by definition.

Given
\[
\Gamma,\Delta_1,\dots,\Delta_n\vdash_D u\subn{x_i}{\lambda y_i.t_i\share*{\vv*z_i}{y_i}}:A\;,
\]
with each $t_i$ a fresh variant of the same term $t$, we have
\[
\Gamma, (x_i:B_i\vlim C_i)_{i\leq n}\vdash_D u:A
\]
for some $B_i\vlim C_i$'s; and for each $i\leq n$,
\[
