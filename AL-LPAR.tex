...
% Somewhere between introduction and Definition 1, outline the basic idea of the sharing construct.

% p.2 each variable occurs at most once in every expression (if this is indeed the case!)

% p.3: "Permutations of closures": is the meaning of "permutations" to be wrt term constructors?  why not "congruence"?

% p.3: why not giving the two functions between lambda calculus and the atomic lambda calculus? they can help a reader at a first reading. Also, at the beginning, I was thinking that SN was an immediate consequence of SN of usual simply typed lambda calculus and your theorem 3. However, this is not the case because of weakening. Maybe you can discuss this point, maybe with an example.

%Page 3. You should say more about the translation to and from lambda calculus. Do they commute with reductions, with normal forms in both calculi? Are they inverse each other?

%Page 4 2.2 Basic properties of the atomic lambda-calculus - You should say more about what you know or conjecture. Is your calculus confluent, or may you have different normal form because you may represent the same sharing in syntactically different way? How long does it take to normalize? I assume it is at least super-exponential in time and space, as it is for ordinary lambda calculus.

%Page 4. Sharing in u occurs only  - You should quote the lemma of your LICS 2013 paper proving it.
...
%
\item in $t\g$ where $\g$ is $\share xu$ or $\distr xy{t^n}$, each $x_i$ must occur in $t$ and becomes bound, and likewise for $t^n\g$.
%
\end{inparaenum}
%
\end{ALdefinition}
