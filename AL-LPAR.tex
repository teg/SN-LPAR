...
%
\emph{Intersection types} \cite{Coppo-DezaniCiancaglini-1980,Pottinger-1980,Krivine-1993} further allow the characterisation of exactly the strongly normalising terms.
%
...
\noindent
The \emph{unfolding} of an atomic lambda-term $t$ is its normal form under $\ALnotbeta$.
%
...
\end{array}
\]
Values are extended to conjunctions of formulas by the following clauses:
...
$ u\{v_1/y_1,\dots,v_k/y_k\} \{\sn (t')^1/x_1,\dots, \sn (t')^n/x_n\} \in |A|$ and by Lemma~\ref{lem:Red-AddSharings}, $ u\{v_1/y_1,\dots,v_k/y_k\} \{\sn (t')^1/x_1,\dots, \sn (t')^n/x_n\}[\sh (t)] \in |A|$ . It follows by Lemma~\ref{lem:IntCaseLambdaSharing} that
>>>>>>> 340c71d8ee5a3d3a46368721e6f117796eb330cd
\\
